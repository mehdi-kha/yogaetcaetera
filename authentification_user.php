	...
	<div class = "container">
		...
		<div class = "row">
			...
			<div class = "col-lg-8 col-lg-offset-1">
				<form class="form-inline" method="post" action="liste_adherents.php">
					<div class="form-group">
						<label class="sr-only" for="user">Nom d'utilisateur</label>
						<input type="text" class="form-control" id="user" placeholder="Mon nom d'utilisateur" name = "user">
					</div>
					<div class="form-group">
						<label class="sr-only" for="mdp">Mot de passe</label>
						<input type="password" class="form-control" id="mdp" placeholder="Password" name = "password">
					</div>
